// Copyright 2020 the Dejs authors. All rights reserved. MIT license.
// This code editable from https://deno.land/x/dejs
...
import { View } from "../../facades/view.ts";
...
async function include(path: string, params: Params): Promise<string> {
  const result = await renderFile(View.parsePath(path), params);
